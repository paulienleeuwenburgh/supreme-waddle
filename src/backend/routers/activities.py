...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty ('Beginner', 'Intermediate', 'Advanced').
      Use 'all' to return activities without difficulty metadata.
    """
    ...
    if difficulty:
        ...
        elif normalized_difficulty in allowed_difficulties:
            query["difficulty"] = allowed_difficulties[normalized_difficulty]
        else:
            raise HTTPException(
                status_code=400,
